...
class Profile extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            updateAccount: false,
            profile: [],
            getProfile: "https://desolate-sierra-00304.herokuapp.com/getProfile/" + this.props.match.params.id,
            initialiseProfile: "https://desolate-sierra-00304.herokuapp.com/profile-initial/" + this.props.match.params.id,
            updateProfile: "https://desolate-sierra-00304.herokuapp.com/profile-update/" + this.props.match.params.id,
            getUserDetails: "https://desolate-sierra-00304.herokuapp.com/getUserDetails/" + this.props.match.params.id,
            email: '',
            bio: '',
            name:'',
            date_joined: 2020,
